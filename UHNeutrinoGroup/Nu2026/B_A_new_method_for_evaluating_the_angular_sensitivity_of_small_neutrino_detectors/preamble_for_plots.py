...
ax.set_xlabel(r'Number of Detected IBDs')
...
plt.tight_layout()
plt.savefig("angular_resolution_analytic_PackFactor.pdf", bbox_inches='tight')
#plt.show()
...
plt.tight_layout()
plt.savefig("angular_resolution_analytic_ylog_PackFactor.pdf", bbox_inches='tight')
