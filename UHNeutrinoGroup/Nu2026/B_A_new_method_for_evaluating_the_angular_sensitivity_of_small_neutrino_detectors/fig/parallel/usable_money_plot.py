...
dataf_5 = "data/func_iter_dx_5_usable.txt"
dataf_50 = "data/func_iter_dx_50_usable.txt"
dataf_150 = "data/func_iter_dx_150_usable.txt"

iter_arr = [100, 100, 100, 100, 100, 100, 100, 100, 100]
...
plt.xlabel("Usable counts $n$")
plt.ylabel("Angular uncertainty $\\delta \\vartheta$ (${}^\\circ$)")
plt.legend()

plt.grid(True, which="both", linestyle="--", linewidth=0.5)

plt.savefig("money_plot_10M_fid_usable.pdf", format="pdf", bbox_inches="tight")
