...
#   Dated: 22 Jan 2025
# (v1.1) Shifted plot tracks to IBD vertex location and created double histogram file.
#   Dated: 26 Jan 2025
...
class DataProcessor():
    ...
    def __init__(self):
        ...
        self.dataFilePath = "../data/100k_run.json"
    ...
    def plotHistogram(self, type_="positron", save=False):
        ...
        if type_ == "neutron":
            ...
            # Fit the curve
            #popt, pcov = curve_fit(self.poissonFunc, xdata, ydata, p0=[mean])

            #print(popt)

            #yfit = []
            #for x in xdata:
            #    yfit.append(70000*self.poissonFunc(x, mean))
...
if __name__ == "__main__":
    ...
    #proc.plotTracks(10)
    """
    Takes tuple (elev, azim, roll).
    """
    proc.plotTracks(1000, view=[20,45,0], save=True)
    #proc.plotTracks(1000, save=False)
