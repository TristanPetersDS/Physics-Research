...
\begin{minipage}[t][\bodyheight][t]{\colwidth}
  \begin{rblock}{Localization of IBD Source}
    \input{content/block1} % Top Left Block
  \end{rblock}

  \vspace{\rblockgap}

  \begin{rblock}{Traditional Approach}
    \input{content/block2} % Bottom Left Block
  \end{rblock}
...
\begin{minipage}[t][\bodyheight][t]{\colwidth}
  \begin{rblock}{Our Approach to Simulation Design}
    \input{content/block3} % Top Center Block
  \end{rblock}

  \vspace{\rblockgap}

  \begin{rblock}{Novel Algorithm for Segmented Detectors}
    \input{content/block4} % Bottom Center Block
  \end{rblock}
...
\begin{minipage}[t][\bodyheight][t]{\colwidth}
  \begin{heroblock}{$\bigstar$\,Conclusions, Findings, and Future Work}
    \input{content/block5} % Rightmost Block
    \vfill
  \end{heroblock}
\end{minipage}%
}% end centered body
